...
public class Cart {
    // Properties
    // 1. Field -> different types of variable
    // 2. Initialization blocks {}
    // 3. Constructors --> Self class default or custom method
    // 4. Methods --> Functions which is called through object
    // 5. Nested Class --> Inner Class again and again
    ...
    // Initialization static and non static blocks
    static {
